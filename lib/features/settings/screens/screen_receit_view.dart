...
class _ScreenReceitViewState extends State<ScreenReceitView> {
          ...
          child: ConstrainedBox(
            ...
            child: isDesktop
                ? Row(
                    ...
                    children: [
                      // Left Column: Summary & Info details
                      Expanded(
                        flex: 9,
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildHeaderSection(isDark, primary),
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 24),
                                    _buildFinancialSection(isDark, primary),
                                  ],
                                ),
                              ),
                            ],
                      ...
                      // Right Column: Items List & Refund/Payment Action Button
                      Expanded(
                        flex: 11,
                        child: Container(
                          padding: const EdgeInsets.all(24),
  ...
  Widget _buildHeaderSection(bool isDark, Color primary) {
    return Container(
  ...
  Widget _buildItemsList(BuildContext context) {
    return Column(
      children: widget.receitModel.items.map((e) {
  ...
  Widget _buildFinancialSection(bool isDark, Color primary) {
    return Column(
      children: [
