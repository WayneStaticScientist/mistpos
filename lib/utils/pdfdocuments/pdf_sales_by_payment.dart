...
class PdfSalesByPayment extends BlankPage {
  final DateTime startDate;
  final DateTime endDate;
  final List<SalesByPayment> salesByPayment;
  final String baseCurrence;
  const PdfSalesByPayment({
    super.key,
  ...
  Widget createPageContent(BuildContext context) {
    ...
    return [
      ...
      _makeTable(salesByPayment),
    ].column();
  }

  Widget _makeTable(List<SalesByPayment> salesByPayment) {
