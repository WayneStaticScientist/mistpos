...
import 'dart:io';
import 'package:mistpos/core/utils/sdk_int.dart'; // Assuming this function exists
  ...
  static Future<void> ensureTlsProviderIsInstalled() async {
    ...
    try {
      ...
      if (success == true) {
        ...
        log("TLS Provider successfully installed/verified.");
      } else {
        // This case handles a non-recoverable native error
        log("TLS Provider failed installation (non-recoverable).");
      }
      ...
      if (e.code == "RECOVERABLE_ERROR") {
        ...
        log("Error installing TLS Provider: ${e.message}");
      }
